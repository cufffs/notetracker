...
EndSelection:<<<<<<<<4";
        ...
        public static DataObject CreateDataObject(string html, string plainText, string rtf)
        {
        ...
        /// <param name="html">a html fragment</param>
        /// <param name="plainText">the plain text</param>
        public static void CopyToClipboard(string html, string plainText, string rtf)
        {
            var dataObject = CreateDataObject(html, plainText, rtf);
